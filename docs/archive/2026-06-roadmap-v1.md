> **Archived 2026-09-05.** This was the first roadmap (read-and-navigate core). Kept for history; checkboxes are frozen as of archiving. The active plan is [docs/ROADMAP.md](../ROADMAP.md).
