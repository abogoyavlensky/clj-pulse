...
- [ ] **Step 1: Refactor `resolve_and_index_libs` to return `ResolvedLibs`**
...
- [ ] **Step 2: Add stage 3 after stage 2 in the library task (`src/server.rs:334`)**
...
- [ ] **Step 3: Move the "no classpath found" warning**
...
- [ ] **Step 4: Re-run stage 3 on `.clj-pulse/config.edn` changes**
...
- [ ] **Step 5: Set the kill-switch in the e2e harness**
...
- [ ] **Step 1: Disabled-mode test (regular, no CLI needed)**
...
- [ ] **Step 2: Alias-navigation test (ignored, modeled on `test_e2e_real_classpath_navigation`, `tests/test_e2e.rs:3237`)**
...
- [ ] **Step 2: Document the config key in README**
